...
const fileSelectRef = useTemplateRef('file-select-ref')
...
<template>
  <div class="flex justify-center">
    <div class="avatar relative">
      ...
      <div @click="fileSelectRef.click()" class="absolute left-0 top-0 w-28 h-28 flex justify-center items-center bg-black/20 rounded-full cursor-pointer">
        <Camera />
      </div>
    </div>
  </div>

  <input ref="file-select-ref" type="file" accept="image/*" class="hidden" @change="onFileChange">
